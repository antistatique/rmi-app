      ...
      <table className="c-selected-mine-sites-table">
        ...
        <thead>
          <tr>
            ...
            {mineSites.map((mineSite, index) => (
              <th className={(mineSites.length - 1) === index ? '' : 'bordered'}>
        ...
        <tbody>
          <tr>
            ...
            {mineSites.map((mineSite, index) => (
              <td className={(mineSites.length - 1) === index ? '' : 'bordered'}>{mineSite.scores.localEmployment ? mineSite.scores.localEmployment : 'NULL'}</td>
            ))}
          </tr>
          <tr>
            <td className="score-title">Local Procurement<br /><span>(score /3)</span></td>
            {mineSites.map((mineSite, index) => (
              <td className={(mineSites.length - 1) === index ? '' : 'bordered'}>{mineSite.scores.localProcurment ? mineSite.scores.localProcurment : 'NULL'}</td>
            ))}
          </tr>
          <tr>
            <td className="score-title">Post-Closure Plans<br /><span>(score /3)</span></td>
            {mineSites.map((mineSite, index) => (
              <td className={(mineSites.length - 1) === index ? '' : 'bordered'}>{mineSite.scores.postClosurePlans ? mineSite.scores.postClosurePlans : 'NULL'}</td>
            ))}
          </tr>
          <tr>
            <td className="score-title">Community Grievances<br /><span>(score /3)</span></td>
            {mineSites.map((mineSite, index) => (
              <td className={(mineSites.length - 1) === index ? '' : 'bordered'}>{mineSite.scores.communityGrievance ? mineSite.scores.communityGrievance : 'NULL'}</td>
            ))}
          </tr>
          <tr>
            <td className="score-title">Worker Grievances<br /><span>(score /3)</span></td>
            {mineSites.map((mineSite, index) => (
              <td className={(mineSites.length - 1) === index ? '' : 'bordered'}>{mineSite.scores.workersGrievance ? mineSite.scores.workersGrievance : 'NULL'}</td>
            ))}
          </tr>
          <tr>
            <td className="score-title">Air Quality<br /><span>(score /3)</span></td>
            {mineSites.map((mineSite, index) => (
              <td className={(mineSites.length - 1) === index ? '' : 'bordered'}>{mineSite.scores.airQuality ? mineSite.scores.airQuality : 'NULL'}</td>
            ))}
          </tr>
          <tr>
            <td className="score-title">Water Quality<br /><span>(score /3)</span></td>
            {mineSites.map((mineSite, index) => (
              <td className={(mineSites.length - 1) === index ? '' : 'bordered'}>{mineSite.scores.waterQuality ? mineSite.scores.waterQuality : 'NULL'}</td>
            ))}
          </tr>
          <tr>
            <td className="score-title">Water Quality<br /><span>(score /3)</span></td>
            {mineSites.map((mineSite, index) => (
              <td className={(mineSites.length - 1) === index ? '' : 'bordered'}>{mineSite.scores.waterQuantity ? mineSite.scores.waterQuantity : 'NULL'}</td>
            ))}
          </tr>
          <tr>
            <td className="score-title">Tailings Management<br /><span>(score /3)</span></td>
            {mineSites.map((mineSite, index) => (
              <td className={(mineSites.length - 1) === index ? '' : 'bordered'}>{mineSite.scores.tailingsManagement ? mineSite.scores.tailingsManagement : 'NULL'}</td>
            ))}
          </tr>
          <tr>
            <td className="score-title">Emergency Preparedness<br /><span>(score /3)</span></td>
            {mineSites.map((mineSite, index) => (
              <td className={(mineSites.length - 1) === index ? '' : 'bordered'}>{mineSite.scores.emergencyPreparedness ? mineSite.scores.emergencyPreparedness : 'NULL'}</td>
            ))}
          </tr>
