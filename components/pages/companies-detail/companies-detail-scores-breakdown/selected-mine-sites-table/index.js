  ...
  render() {
    ...
    return (
      <table className="c-selected-mine-sites-table">
        ...
        <tbody>
          <tr>
            <td className="score-title">Local Employment<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
          ...
          <tr>
            <td className="score-title">Local Procurement<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
          ...
          <tr>
            <td className="score-title">Air Quality<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
          ...
          <tr>
            <td className="score-title">Water Quality<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
          ...
          <tr>
            <td className="score-title">Water Quantity<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
          ...
          <tr>
            <td className="score-title">Rehabilitation and Post-Closure<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
          ...
          <tr>
            <td className="score-title">Tailings Management<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
          ...
          <tr>
            <td className="score-title"> Safety of Communities<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
          ...
          <tr>
            <td className="score-title">Community Grievances<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
          ...
          <tr>
            <td className="score-title">Safety and Health of Workers<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
          ...
          <tr>
            <td className="score-title">Women Workers<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
          ...
          <tr>
            <td className="score-title">Workplace Deaths and Injuries<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
          ...
          <tr>
            <td className="score-title">Training of Workers<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
          ...
          <tr>
            <td className="score-title">Decent Living Wage<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
          ...
          <tr>
            <td className="score-title">Worker Grievances<br /><span>(score /4)</span></td>
            {mineSites.map((mineSite, index) => (
