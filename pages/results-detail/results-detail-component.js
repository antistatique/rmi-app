...
class ResultsDetailPage extends Page {
  static async getInitialProps(context) {
    ...
    await context.store.dispatch(getIssueAreas({
      ...
      include: ['children', 'scores', 'scores.company', 'children.children', 'children.children.scores', 'children.children.leading-practices', 'children.children.companies-max-scores', 'children.children.leading-practices.companies'].join(','),
      'page[size]': 1000
    }));
